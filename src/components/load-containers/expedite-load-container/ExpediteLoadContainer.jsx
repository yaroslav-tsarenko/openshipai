...
import "./ExpediteLoadContainer.css";
...
const ExpediteLoadContainer = ({pickupLocation, deliveryLocation, loadType, loadSubType, loadPickupDate, loadDeliveryDate, loadPickupTime, loadDeliveryTime,}) => {
    ...
    return (
        <div className="expedite-load-container-wrapper">
            ...
            <div className="expedite-load-container-content">
                ...
                <div className="expedite-load-optional-inputs">
                ...
                <div className="expedite-load-description">
            ...
            <div className="expedite-load-container-content-tips">
...
export default ExpediteLoadContainer;