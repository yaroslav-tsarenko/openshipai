...
const HeavyLiftingAndMovingOnly = ({
    ...
    return (
        <>
            <SEO
                title="Heavy Lifting and Moving - Professional and Safe Services"
                description="Get professional and safe heavy lifting and moving services. Contact us for a quote and ensure your heavy items are moved securely."
                keywords="heavy lifting, moving services, professional moving, safe lifting"
            />
