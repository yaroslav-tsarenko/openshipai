...
import "./FarmEquipmentLoadContainer.css";
...
import {ReactComponent as AttachFile} from "../../../assets/images/files-icon.svg";
    ...
    return (
        <div className="farm-equipment-container-wrapper">
            ...
            <div className="farm-equipment-container-content">
                ...
                <div className="farm-equipment-optional-inputs">
            ...
            <div className="farm-equipment-container-content-tips">
