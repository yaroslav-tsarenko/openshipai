...
const CommercialTruckLoad = ({pickupLocation, deliveryLocation, loadType}) => {
    ...
    return (
        <div className="commercial-truck-load-container-wrapper">
            ...
            <div className="commercial-truck-load-container-content">
                <div className="commercial-truck-loads-container-inputs">
                    <section>
                ...
                <div className="commercial-truck-load-additional-options">
                    <div className="commercial-truck-loads-container-switchers">
                        <Switch
                            isOn={isSecondSwitch}
                            handleToggle={() => {
                    ...
                    <div className="commercial-truck-load-optional-inputs">
