...
import "./SailboatLoadContainer.css";
                ...
                <div className="boat-loads-container-inputs">
                    ...
                    <section>
                        <div className="google-input-wrapper">
                            ...
                            />
                            <label htmlFor="loadVehicleYear" className="google-style-input-label">Sailboat year</label>
                        </div>
                    </section>
                    <section>
                        <div className="google-input-wrapper">
                            ...
                            />
                            <label htmlFor="loadVehicleMake" className="google-style-input-label">Sailboat Make</label>
                        </div>
                    </section>
                    <section>
                        <div className="google-input-wrapper">
