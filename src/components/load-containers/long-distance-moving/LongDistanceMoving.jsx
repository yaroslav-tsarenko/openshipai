...
const LongDistanceMoving = ({
    ...
    return (
        <>
            <SEO
                title="Long Distance Moving - Safe and Reliable Moving Services"
                description="Ensure a safe and reliable long distance move with our professional services. Contact us for a quote!"
                keywords="long distance moving, reliable moving services, safe moving, long distance relocation"
            />
            ...
            <CreateLoadContainer step={4} title="Long Distance Moving" subTitle="Try to fill all neccesary fields">
                <TextInput
                    id="loadTitle"
