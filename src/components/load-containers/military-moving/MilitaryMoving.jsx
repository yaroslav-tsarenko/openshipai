...
const MilitaryMoving = ({pickupLocation, deliveryLocation, loadType, loadSubType, loadPickupDate, loadDeliveryDate, loadPickupTime, loadDeliveryTime,}) => {
    ...
    return (
        <div className="military-moving-load-container-wrapper">
            ...
            <div className="military-moving-load-container-content">
                <section className="load-title-section">
                    <h1>Military Moving</h1>
                    <p>Try to fill all necessary fields</p>
                </section>
                <div className="military-moving-loads-container-inputs">
                    <section>
                        ...
                        <Box sx={{minWidth: 180, height: '50px'}}>
                            <FormControl fullWidth style={{fontSize: '15px',}}>
                                <InputLabel id="demo-simple-select-label"
                                    ...
                                    pallets/boxes</InputLabel>
                                <Select
                                    labelId="loadNumberOfPallets"
                                    id="loadNumberOfPallets"
                                    label="Number of bedrooms"
                                    name="loadNumberOfPallets"
                                    value={formData.loadNumberOfPallets}
                                    onChange={(event) => {
                                        handleLoadChange("loadNumberOfPallets")(event);
                                    }}
                                    style={{
                                        fontSize: '15px',
                                        fontWeight: 'normal',
                ...
                <div className="military-moving-load-optional-inputs">
                ...
                <div className="military-moving-load-description">
            ...
            <div className="military-moving-load-container-content-tips">
