...
const MilitaryMoving = ({
    ...
    return (
        <>
            <SEO
                title="Military Moving - Professional and Secure Moving Services"
                description="Get professional and secure military moving services. Contact us for a quote and ensure a smooth transition for military personnel."
                keywords="military moving, professional moving services, secure moving, military relocation"
            />
