...
const OfficeMoving = ({pickupLocation, deliveryLocation, loadType, loadSubType, loadPickupDate, loadDeliveryDate, loadPickupTime, loadDeliveryTime,}) => {
    ...
    return (
        <div className="office-moving-container-wrapper">
            ...
            <div className="office-moving-container-content">
                ...
                <div className="office-moving-optional-inputs">
                ...
                <div className="office-moving-description">
            ...
            <div className="office-moving-container-content-tips">
