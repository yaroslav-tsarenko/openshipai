...
const HouseHoldItem = ({pickupLocation, deliveryLocation, loadType, loadSubType, loadPickupDate, loadDeliveryDate, loadPickupTime, loadDeliveryTime,}) => {
    ...
    return (
        <div className="household-item-load-container-wrapper">
            ...
            <div className="household-item-load-container-content">
                <section className="load-title-section">
                    <h1>Household item</h1>
                    <p>Try to fill all necessary fields</p>
                </section>
                <div className="household-item-loads-container-inputs">
                    <section>
                ...
                <div className="household-item-type-of-trailer-load">
                    <h2>How many items need to be moved</h2>
                    <p>Choose option</p>
                    <div className="household-item-loads-container-inputs">
                ...
                <div className="household-item-load-optional-inputs">
                ...
                <div className="household-item-load-description">
            ...
            <div className="household-item-load-container-content-tips">
