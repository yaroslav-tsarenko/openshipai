                ...
                <div className="admin-content-wrapper">
                    ...
                    <div className="admin-inner-content-second">
                        ...
                        <div className="data-operations-wrapper">
                            ...
                            <button className="custom-button-filter">
                                <FontAwesomeIcon
                        ...
                        {commercialTruckLoads.map((load, index) => (
                            <div className="table-items-wrapper">
                                <div className={`table-item ${load === selectedLoad ? 'selected' : ''}`}
                                    ...
                                    <div>{load.vehicleModel}</div>
                                    <div>Pending</div>
                                    <div>{load.commercialLoadID}</div>
                                    {bid ?
                                        <Link

                                            to={`/bids-page/${personalEndpoint}`}>
                                            <button className="check-proposals-button"><p>View Proposals!</p></button>
                                        </Link>
                                        :
                                        <div className="p-price">Waiting for proposal</div>
                                    }
