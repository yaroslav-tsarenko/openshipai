                            ...
                            <div className="account-carrier-settings">
                                ...
                                <form onSubmit={handleFormSubmit}>
                                    <div className="carrier-data-changing">
                                        <label>Name</label>
                                        <input type="text" name="name" placeholder={carrier.name}
                                               onChange={handleFormChange}/>
                                    </div>
                                    <div className="carrier-data-changing">
                                        <label>Email</label>
                                        <input type="text" name="email" placeholder={carrier.email}
                                               onChange={handleFormChange}/>
                                    </div>
                                    <div className="carrier-data-changing">
                                    ...
                                    <div className="carrier-data-changing">
                                        ...
                                        <input type="text" name="companyName" onChange={handleFormChange}
                                               placeholder={carrier.companyName}/>
                                    </div>
                                    <div className="carrier-data-changing">
                                        <label>DUNS Number</label>
                                        <input type="text" name="dunsNumber" onChange={handleFormChange}
                                               placeholder={carrier.dunsNumber}/>
                                    </div>
                                    <div className="carrier-data-changing">
                                        <label>US Docket</label>
                                        <input type="text" name="usDocket" onChange={handleFormChange}
                                               placeholder={carrier.usDocket}/>
                                    </div>
                                    <div className="carrier-data-changing">
                                        <label>US DOT Number</label>
                                        <input type="text" name="usDotNumber" onChange={handleFormChange}
                                               placeholder={carrier.usDotNumber}/>
                                    </div>
