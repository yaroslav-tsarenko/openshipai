...
const LoadContainerBid = ({
    ...
    return (
        <>
            {isSuccess && <FloatingWindowSuccess text="Load Created Successfully"/>}
                    ...
                    <div className="bid-popup">
                        ...
                        <div className="bid-popup-content">
                            <div className="bid-description">
                                <h3>Before bid</h3>
                                <p>Before bid we highly recommend to come up short but compelling message for customer
                            ...
                            <div className="google-input-wrapper">
                                ...
                                />
                                <label htmlFor="loadBidCoverLetter" className="google-style-input-label">Type message
                                    here</label>
                            </div>
