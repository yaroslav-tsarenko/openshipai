                    ...
                    <section className="dashboard-sidebar-main-buttons">
                        ...
                        {DashboardAI && DashboardAI.visible && (
                            ...
                            >
                                {hoveredButton === 'Dashboard' ?
                                    <DashboardIconWhite className="dashboard-link-nav-button-icon" /> :
                        ...
                        {TakeLoad && TakeLoad.visible && (
                            <Link
                                ...
                                onMouseLeave={() => setHoveredButton('')}
                            >
                                {hoveredButton === 'TakeLoad' ?
                                    <LoadIconWhite className="dashboard-link-nav-button-icon" /> :
                        ...
                        {MyLoads && MyLoads.visible && (
                            ...
                            >
                                {hoveredButton === 'Loads' ?
                                    <LoadBoxIconWhite className="dashboard-link-nav-button-icon" /> :
                        ...
                        {DriversAndEquip && DriversAndEquip.visible && (
                            <Link
                                ...
                                onMouseLeave={() => setHoveredButton('')}
                            >
                                {hoveredButton === 'TireIcon' ?
                                    <TireIconWhite className="dashboard-link-nav-button-icon" /> :
                        ...
                        {Payments && Payments.visible && (
                            ...
                            >
                                {hoveredButton === 'Payments' ?
                                    <PaymentIconWhite className="dashboard-link-nav-button-icon" /> :
                        ...
                        {Settings && Settings.visible && (
                            ...
                            >
                                {hoveredButton === 'Settings' ?
                                    <SettingsIconWhite className="dashboard-link-nav-button-icon" /> :
