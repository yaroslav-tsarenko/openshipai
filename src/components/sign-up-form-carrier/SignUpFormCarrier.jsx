            ...
            return (
                <div className="sign-in-wrapper">
                    <div className="left-side">
                        ...
                        <h2>Step 4</h2>
                        <input className="input-field-name" type="text" placeholder="Phone Number" value={formData.phoneNumber} onChange={handleChange('phoneNumber')}/>
                        <input className="input-field-name" type="text" placeholder="DUNS Number" value={formData.dunsNumber} onChange={handleChange('dunsNumber')}/>
                        <button className="hide-details-button" onClick={prevStep}>Previous</button>
